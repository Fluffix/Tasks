//Задача 1: глобальная переменная 'a' вне класса//
...
значение не может быть изменено никаким образом. Также 'final' можно проинициализировать
как сразу, так и позже, что нельзя сказать о 'const'*/
...
void main() {
  ...
  list.forEach((element) {
    if (1 <= element && element <= 3) {
      list[list.indexOf(element)] *= 10;
    }
    ;
  });
